...
def process_song_data(spark, input_data, output_data):
    ...
    .parquet('s3a://mkgpublic/simple_udacity/songs_dim/songs_dim.parquet')
    ...
    .option('fs.s3a.committer.staging.conflict-mode', 'replace') \
    .option("fs.s3a.fast.upload.buffer", "bytebuffer") \
    .parquet('s3a://mkgpublic/simple_udacity/artists_dim/artists_dim.parquet')
...
def process_log_data(spark, input_data, output_data):
    ...
    .option('fs.s3a.committer.staging.conflict-mode', 'replace') \
    .option("fs.s3a.fast.upload.buffer", "bytebuffer") \
    .parquet('s3a://mkgpublic/simple_udacity/users_dim/users_dim.parquet')
    ...
    .option('fs.s3a.committer.staging.conflict-mode', 'replace') \
    .option("fs.s3a.fast.upload.buffer", "bytebuffer") \
    .parquet('s3a://mkgpublic/simple_udacity/date_dim/date_dim.parquet')
    
    print("Finished date_dim write to S3")
    # read in song data to use for songplays table
    print("Starting songs_dim read from S3")
    songs_dim_parquet = 's3a://mkgpublic/simple_udacity/songs_dim/'
    ...
    .option('fs.s3a.committer.staging.conflict-mode', 'replace') \
    .option("fs.s3a.fast.upload.buffer", "bytebuffer") \
    .parquet('s3a://mkgpublic/simple_udacity/songplays/songplays.parquet')
